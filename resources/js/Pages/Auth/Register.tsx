...
export default function Register() {
    ...
    const submit: FormEventHandler = async (e) => {
        ...
        // Append all data including the profile picture
        ...
        post(route("register"), {
            ...
            onError: (errors) => {
                ...
                if (errorMessages.length > 0) {
                    toast.error(errorMessages.join(", ")); // Display all errors
                } else {
                    toast.error(
        ...
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                <div className="p-4 h-[500px] overflow-auto">
                    <br />
                    <h1 className="text-center text-bolder text-[25px] text-slate-800">
                    ...
                    <div className="mt-4">
                        <div className="mt-4">
                            ...
                            <select
                                ...
                                name="sex"
                                value={data.sex}
                                className="mt-1 block w-[200px] rounded-xl "
